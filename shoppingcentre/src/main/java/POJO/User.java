...
public class User {
    ...
    public User(int uid,int aid,String name,String email,String uname,String password,String p_no,HashMap<Integer,String> address,HashMap<Integer,String> pincode){
        this.uid = uid;
